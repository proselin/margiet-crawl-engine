...
export class SwaggerConfig {
  ...
  static setupOpenApi(app: INestApplication, options: {
    hostInput?: string,
    portInput?: number,
    prefixInput?: string,
    ...
    const prefix = options.prefixInput || configService.get('SERVER_API_DOCUMENT_PREFIX') || 'doc';
    const config = options.configInput || new DocumentBuilder()
