...
export interface IBaseCurl<Entity = any> {
  createOne(createDto: Record<string, any>): Promise<Entity & HydratedDocument<Entity>>;

  findAll(): Promise<Array<Entity & HydratedDocument<Entity>>>;

  findById(id: string | number | object, opts?: QueryOptions<any>): Promise<Entity & HydratedDocument<Entity>>;
